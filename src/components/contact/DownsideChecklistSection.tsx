...
export function DownsideChecklistSection() {
  ...
  return (
    <Section id="downside-checklist" className="scroll-mt-24">
        ...
        {submitted ? (
          <div className="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Check your inbox. If you don&apos;t see it, check spam or reach out
              directly.
            </p>
          </div>
        ) : (
          ...
          >
            ...
            <p className="text-xs text-slate-500">
              We do not share your information. Communications are
              informational.
            </p>
            <button
              type="submit"
